...
if (lab):
    ...
    model_path = "drive/model_vizdoom_a3c_hgs/"
...
def Test(agent):
    ...
    if (test_write_video):
        ...
        out_video_1 = cv2.VideoWriter("drive/testt_a3c_hgs_1.avi", fourcc, fps, size)
        out_video_2 = cv2.VideoWriter("drive/testt_a3c_hgs_2.avi", fourcc, fps, size)
        out_video_3 = cv2.VideoWriter("drive/testt_a3c_hgs_3.avi", fourcc, fps, size)
        out_video_4 = cv2.VideoWriter("drive/testt_a3c_hgs_4.avi", fourcc, fps, size)
        out_video_5 = cv2.VideoWriter("drive/testt_a3c_hgs_5.avi", fourcc, fps, size)
        out_video_6 = cv2.VideoWriter("drive/testt_a3c_hgs_6.avi", fourcc, fps, size)
        out_video_7 = cv2.VideoWriter("drive/testt_a3c_hgs_7.avi", fourcc, fps, size)
        out_video_8 = cv2.VideoWriter("drive/testt_a3c_hgs_8.avi", fourcc, fps, size)
        out_video_9 = cv2.VideoWriter("drive/testt_a3c_hgs_9.avi", fourcc, fps, size)
        out_video_10 = cv2.VideoWriter("drive/testt_a3c_hgs_10.avi", fourcc, fps, size) 
